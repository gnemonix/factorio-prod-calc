...
function init_player_gui(player)
  ...
  if game_mode_button then
    ...
    if game_mode_button.name == "production_score_button" then
      button_flow.add{type = "button", caption = {"prod_score_calculator"}, name = "production_score_calculator_button", style = mod_gui.button_style}
    end
  end
  if player.admin then
